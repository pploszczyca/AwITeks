...
public class MockConfiguration {
    ...
    public Repository<Plant> getPlantRepository(User user, Repository<Species> speciesRepository, Species species, String url) {
        ...
        Activity activity1 = new Activity(0, plant1, ActivityType.FERTILISATION, new Date(12,12,2000));
        Activity activity11 = new Activity(1, plant1, ActivityType.WATERING, new Date(12,12,2000));

        Plant plant2 = new Plant(1, "My Fiołek", user, speciesRepository.get(2).get(), "Simple Fiołek note", Insolation.LOW, url);
        Activity activity2 = new Activity(2, plant2, ActivityType.FERTILISATION, new Date(12,12,2000));
        Activity activity22 = new Activity(3, plant2, ActivityType.WATERING, new Date(12,12,2000));

        Plant plant3 = new Plant(2, "My Storczyk", user, speciesRepository.get(3).get(), "Simple Storczyk note", Insolation.HIGH, url);
        Activity activity3 = new Activity(4, plant2, ActivityType.FERTILISATION, new Date(12,12,2000));
        Activity activity33 = new Activity(5, plant2, ActivityType.WATERING, new Date(12,12,2000));

        Plant plant4 = new Plant(3, "My Bazylia", user, speciesRepository.get(4).get(), "Simple Bazylia note", Insolation.HIGH, "eh");
        Activity activity4 = new Activity(6, plant2, ActivityType.FERTILISATION, new Date(12,12,2000));
        Activity activity44 = new Activity(7, plant2, ActivityType.WATERING, new Date(12,12,2000));

        Plant plant5 = new Plant(4, "My Mięta", user, speciesRepository.get(5).get(), "Simple Mięta note", Insolation.HIGH, true, url);
        Activity activity5 = new Activity(8, plant2, ActivityType.FERTILISATION, new Date(12,12,2000));
        Activity activity55 = new Activity(9, plant2, ActivityType.WATERING, new Date(12,12,2000));
