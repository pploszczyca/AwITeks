        ...
        <Modal show={show} onHide={() => updateState(false)} animation={false} size="xl">
            ...
            <Modal.Body>
                <Formik
                    ...
                    validate={values => {
                        const errors: any = {};
                        if (!values.scientificPlantName) errors.scientificPlantName = 'Required';
                        if(!values.userPlantName) errors.userPlantName = 'Required';
                            ...
                            <Container>
                                <Row>
                                    ...
                                    <Col className="form-group mt-3" xl={4} md={6} sm={12}>
                                        ...
                                        <Button variant="info">Dodaj nowy gatunek</Button>
                                    </Col>
                                    <Col className="form-group mt-3" xl={4} md={6} sm={12}>
